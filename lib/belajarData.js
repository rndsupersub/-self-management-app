        ...
        tools: [
          ...
          },
          {
            ...
            fitur: [
                ...
                fitur: [
                  {
                    ...
                    materi:
                      "📌 Pengenalan Sketch\n" +
                      "• Sketch = gambar 2D yang jadi dasar semua fitur 3D.\n" +
                      "• Tools dasar: Line, Circle, Rectangle, Arc, Spline.\n" +
                      "• Relation: Horizontal, Vertical, Coincident, Tangent, Parallel, Perpendicular, Equal, Concentric.\n" +
                      "• Smart Dimension: ukuran panjang, sudut, radius, diameter.\n" +
                      "• Trim, Extend, Offset, Mirror, Convert Entities.\n" +
                      "• Construction Line (garis bantu).\n" +
                      "• Fully Defined sketch = garis udah paten (warna hitam).\n" +
                      "• Under Defined = masih bisa gerak (warna biru).\n\n" +
                      "📌 Best Practice\n" +
                      "• Selalu bikin sketch Fully Defined sebelum lanjut ke fitur 3D.\n" +
                      "• Pakai origin (titik 0,0,0) sebagai patokan.\n" +
                      "• Manfaatkan relation biar sketch auto-adjust.\n\n" +
                      "📌 Sumber: SolidWorks Tutorial for Beginners #1, #2A, #2B, #2.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Extrude Boss/Base\n" +
                      "• Fungsi: narik sketch 2D jadi solid 3D.\n" +
                      "• Parameter: Blind, Up to Vertex, Up to Surface, Offset, Mid Plane, Up to Next, Up to Body.\n" +
                      "• Direction 1 & Direction 2 (bisa dua arah).\n" +
                      "• Draft: bikin kemiringan saat extrude.\n" +
                      "• Thin Feature: extrude tipis (kayak plat).\n\n" +
                      "📌 Best Practice\n" +
                      "• Pilih bidang sketch yang tepat sebelum extrude.\n" +
                      "• Cek arah extrude (kadang kebalik).\n" +
                      "• Pakai Mid Plane kalau mau simetris.\n\n" +
                      "📌 Sumber: SolidWorks Tutorial for Beginners - 3.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Extruded Cut\n" +
                      "• Fungsi: motong solid 3D pakai sketch 2D.\n" +
                      "• Parameter sama kayak Extrude Boss/Base.\n" +
                      "• Bisa Through All, Through All Both, Up to Next, Up to Surface.\n" +
                      "• Flip side to cut: motong di sisi sebaliknya.\n\n" +
                      "📌 Best Practice\n" +
                      "• Pastikan sketch cut ada di bidang yang bener.\n" +
                      "• Kalau motong tembus, pakai Through All biar aman.\n" +
                      "• Cek hasil cut sebelum lanjut ke fitur berikutnya.\n\n" +
                      "📌 Sumber: SolidWorks Tutorial for Beginners - 3.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Revolved Boss/Base\n" +
                      "• Fungsi: muter sketch 2D mengelilingi sumbu jadi solid 3D.\n" +
                      "• Butuh: sketch profil + centerline (sumbu putar).\n" +
                      "• Parameter: angle (default 360°), direction, thin feature.\n\n" +
                      "📌 Revolved Cut\n" +
                      "• Fungsi: motong solid pakai revolve.\n" +
                      "• Sama kayak Revolved Boss, tapi hasilnya cut.\n\n" +
                      "📌 Best Practice\n" +
                      "• Centerline harus di luar profil (biar nggak self-intersect).\n" +
                      "• Cocok buat bikin benda putar: poros, botol, roda, dll.\n\n" +
                      "📌 Sumber: SolidWorks Revolved Boss Base | Revolved Cut Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Fillet\n" +
                      "• Fungsi: bikin sudut tumpul/radius.\n" +
                      "• Tipe: Constant Size, Variable Size, Face Fillet, Full Round Fillet.\n" +
                      "• Parameter: radius, edges/faces yang dipilih.\n\n" +
                      "📌 Chamfer\n" +
                      "• Fungsi: bikin sudut miring 45° (atau custom).\n" +
                      "• Tipe: Angle-Distance, Distance-Distance, Vertex.\n\n" +
                      "📌 Fitur Lain di Video Ini\n" +
                      "• Plane: bikin bidang baru (offset, angle, parallel).\n" +
                      "• Mirror: mirror fitur/body ke bidang lain.\n" +
                      "• Mass Properties: cek volume, massa, center of gravity.\n" +
                      "• Measure: ukur jarak, sudut, radius.\n\n" +
                      "📌 Best Practice\n" +
                      "• Fillet/Chamfer sebaiknya di akhir (biar nggak error saat edit).\n" +
                      "• Pakai Variable Size buat fillet yang berubah-ubah.\n\n" +
                      "📌 Sumber: SolidWorks Basics Tutorial for Beginners - 5.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Rib Feature\n" +
                      "• Fungsi: nambahin tulang penguat (rib) di solid.\n" +
                      "• Parameter: thickness, rib direction, draft.\n" +
                      "• Bisa multiple rib sekaligus.\n\n" +
                      "📌 Draft\n" +
                      "• Fungsi: bikin kemiringan di permukaan (buat mold/parting line).\n" +
                      "• Parameter: draft angle, neutral plane, faces yang di-draft.\n" +
                      "• Draft analysis: cek mana yang perlu di-draft.\n\n" +
                      "📌 Best Practice\n" +
                      "• Rib cocok buat part plastik (biar kuat tapi hemat material).\n" +
                      "• Draft wajib buat part yang mau di-mold.\n\n" +
                      "📌 Sumber: SolidWorks Tutorials for Beginners - 6.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Pattern Feature\n" +
                      "• Fungsi: duplikat fitur/body secara teratur.\n\n" +
                      "📌 Tipe Pattern\n" +
                      "• Linear Pattern: duplikat sepanjang garis/lurus (1 atau 2 arah).\n" +
                      "• Circular Pattern: duplikat mengelilingi sumbu.\n" +
                      "• Curve Driven Pattern: duplikat sepanjang curve/spline.\n" +
                      "• Sketch Driven Pattern: duplikat berdasarkan titik di sketch.\n" +
                      "• Table Driven Pattern: duplikat berdasarkan koordinat di tabel.\n" +
                      "• Fill Pattern: duplikat mengisi area tertentu.\n\n" +
                      "📌 Parameter\n" +
                      "• Spacing, jumlah instance, direction, axis.\n" +
                      "• Instances to Skip: lewatin beberapa instance.\n" +
                      "• Vary Sketch: ubah ukuran tiap instance.\n\n" +
                      "📌 Best Practice\n" +
                      "• Pakai pattern biar file ringan (nggak perlu bikin manual satu-satu).\n" +
                      "• Edit pattern = edit semua instance sekaligus.\n\n" +
                      "📌 Sumber: SolidWorks Pattern Feature Tutorial Complete.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    id: "swept",
                    nama: "Swept Boss/Base",
                    materi:
                      "📌 Swept Boss/Base\n" +
                      "• Fungsi: nyapu profil 2D sepanjang path (jalur).\n" +
                      "• Butuh: sketch profil + sketch path.\n" +
                      "• Parameter: profile, path, guide curves, start/end tangency.\n" +
                      "• Twist along path: puter profil sepanjang path.\n" +
                      "• Keep normal constant: profil selalu tegak lurus path.\n\n" +
                      "📌 Swept Cut\n" +
                      "• Fungsi: sama kayak Swept Boss, tapi hasilnya cut.\n\n" +
                      "📌 Best Practice\n" +
                      "• Profil dan path harus di bidang yang berbeda.\n" +
                      "• Cocok buat bikin pipa, kabel, pegas, dll.\n\n" +
                      "📌 Sumber: SolidWorks Swept Boss/Base | Swept Cut Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    id: "lofted",
                    nama: "Lofted Boss/Base",
                    materi:
                      "📌 Lofted Boss/Base\n" +
                      "• Fungsi: nyambungin beberapa profil (sketch) jadi solid.\n" +
                      "• Butuh: minimal 2 sketch profil di bidang berbeda.\n" +
                      "• Parameter: profiles, guide curves, centerline, start/end constraints.\n" +
                      "• Thin feature: loft tipis.\n\n" +
                      "📌 Loft Cut\n" +
                      "• Fungsi: sama kayak Loft Boss, tapi hasilnya cut.\n\n" +
                      "📌 Best Practice\n" +
                      "• Urutan profil ngaruh ke hasil loft.\n" +
                      "• Pakai guide curves biar bentuknya lebih terkontrol.\n" +
                      "• Cocok buat bikin transisi antar bentuk (misal: kotak ke bulat).\n\n" +
                      "📌 Sumber: SolidWorks Lofted Boss/Base | Loft Cut Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    id: "boundary",
                    nama: "Boundary Boss/Base",
                    materi:
                      "📌 Boundary Boss/Base\n" +
                      "• Fungsi: mirip Loft, tapi lebih fleksibel (bisa 2 arah).\n" +
                      "• Butuh: curve di direction 1 & direction 2.\n" +
                      "• Parameter: direction 1, direction 2, tangency, guide curves.\n\n" +
                      "📌 Bedanya sama Loft\n" +
                      "• Loft: profil harus di bidang sejajar.\n" +
                      "• Boundary: profil bisa di bidang apa aja, lebih bebas.\n" +
                      "• Boundary lebih powerful buat bentuk kompleks.\n\n" +
                      "📌 Best Practice\n" +
                      "• Pakai Boundary kalau Loft nggak bisa.\n" +
                      "• Cocok buat surface modeling.\n\n" +
                      "📌 Sumber: SolidWorks Boundary Boss/Base Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 3D Sketch\n" +
                      "• Fungsi: bikin sketch di ruang 3D (bukan cuma 1 bidang).\n" +
                      "• Bisa pindah-pindah bidang saat bikin garis.\n" +
                      "• Tools: line, spline, dimension, relation.\n\n" +
                      "📌 Penggunaan\n" +
                      "• Biasanya buat path swept, guide curve, atau routing.\n" +
                      "• Angle dimension: ukur sudut antar garis di 3D.\n\n" +
                      "📌 Best Practice\n" +
                      "• 3D sketch lebih susah dikontrol dari 2D sketch.\n" +
                      "• Pakai construction line biar rapi.\n" +
                      "• Cocok buat pipa, kabel, rangka.\n\n" +
                      "📌 Sumber: SolidWorks 3D Sketch Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                ],
                ...
                fitur: [
                  {
                    ...
                    materi:
                      "📌 Assembly Dasar\n" +
                      "• Assembly = gabungan beberapa part jadi satu kesatuan.\n" +
                      "• Insert part: drag dari file explorer atau Insert > Component.\n" +
                      "• Mates: hubungan antar part biar gerakannya terkontrol.\n\n" +
                      "📌 Jenis Mates Dasar\n" +
                      "• Coincident: dua permukaan nempel.\n" +
                      "• Parallel: dua permukaan sejajar.\n" +
                      "• Perpendicular: dua permukaan tegak lurus.\n" +
                      "• Tangent: dua permukaan bersinggungan.\n" +
                      "• Concentric: dua lingkaran sepusat.\n" +
                      "• Distance: jarak antar part.\n" +
                      "• Angle: sudut antar part.\n\n" +
                      "📌 Fitur Lain\n" +
                      "• Mirror Component: mirror part di assembly.\n" +
                      "• Exploded View: pecah assembly jadi bagian-bagian.\n\n" +
                      "📌 Best Practice\n" +
                      "• Jangan over-constrain (mates terlalu banyak).\n" +
                      "• Pakai nama yang rapi biar gampang dicari.\n\n" +
                      "📌 Sumber: SolidWorks Assembly Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Advanced Mates\n" +
                      "• Symmetric: dua part simetris terhadap bidang.\n" +
                      "• Linear Coupler: gerakan satu part ngikutin part lain (rasio).\n" +
                      "• Width: dua part sejajar dengan jarak tertentu.\n" +
                      "• Angle: sudut antar part.\n" +
                      "• Distance: jarak antar part.\n" +
                      "• Path Mate: part gerak sepanjang path.\n\n" +
                      "📌 Best Practice\n" +
                      "• Advanced Mates bikin assembly lebih fleksibel.\n" +
                      "• Cocok buat simulasi gerakan (mekanisme).\n\n" +
                      "📌 Sumber: SolidWorks Assembly Tutorial | Advanced Mates.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    id: "assembly_new_part",
                    nama: "Assembly New Part",
                    materi:
                      "📌 New Part di Assembly\n" +
                      "• Bikin part baru langsung di dalam assembly.\n" +
                      "• Part baru otomatis ke-save terpisah.\n\n" +
                      "📌 Fitur Terkait\n" +
                      "• Linear Component Pattern: duplikat part secara linear.\n" +
                      "• Circular Component Pattern: duplikat part secara circular.\n" +
                      "• Hole Series: bikin lubang yang nyambung antar part.\n" +
                      "• Bill of Materials (BOM): daftar part di assembly.\n" +
                      "• Balloons: nomor part di drawing.\n\n" +
                      "📌 Best Practice\n" +
                      "• Bikin part di assembly cocok buat part yang nyambung.\n" +
                      "• BOM otomatis update kalau ada part baru.\n\n" +
                      "📌 Sumber: SolidWorks Assembly New Part Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    ...
                    materi:
                      "📌 Exploded View\n" +
                      "• Fungsi: pecah assembly jadi bagian-bagian terpisah.\n" +
                      "• Bisa dipakai buat animasi assembly/disassembly.\n\n" +
                      "📌 Cara Bikin\n" +
                      "• Buka tab Assembly > Exploded View.\n" +
                      "• Pilih part, tarik ke arah tertentu.\n" +
                      "• Bisa multiple explode step.\n\n" +
                      "📌 Animasi\n" +
                      "• Animation: gerakan part dari posisi awal ke exploded.\n" +
                      "• Playback Mode: play animasi.\n" +
                      "• Collapse: balikin ke posisi awal.\n\n" +
                      "📌 Best Practice\n" +
                      "• Exploded View cocok buat manual book / presentasi.\n" +
                      "• Bisa di-export jadi video.\n\n" +
                      "📌 Sumber: SolidWorks Exploded View Tutorial Complete.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                ],
                ...
                fitur: [
                  {
                    ...
                    materi:
                      "📌 Drawing / Drafting\n" +
                      "• Fungsi: bikin gambar teknik 2D dari part/assembly.\n" +
                      "• Otomatis ke-update kalau model diubah.\n\n" +
                      "📌 Jenis View\n" +
                      "• Model View: view utama.\n" +
                      "• Standard 3 View: tampak depan, atas, samping.\n" +
                      "• Projected View: view tambahan dari view yang ada.\n" +
                      "• Auxiliary View: view miring.\n" +
                      "• Section View: potongan.\n" +
                      "• Aligned Section: potongan sejajar.\n" +
                      "• Detail View: zoom bagian tertentu.\n" +
                      "• Broken-Out Section: potongan sebagian.\n" +
                      "• Break View: view yang dipotong (buat benda panjang).\n" +
                      "• Crop View: crop view.\n\n" +
                      "📌 Anotasi\n" +
                      "• Dimension: ukuran.\n" +
                      "• Notes: catatan.\n" +
                      "• GD&T: toleransi geometri.\n" +
                      "• Surface Finish: kekasaran permukaan.\n\n" +
                      "📌 Best Practice\n" +
                      "• Pakai template drawing yang udah ada.\n" +
                      "• Skala sesuai kebutuhan (1:1, 1:2, 2:1).\n\n" +
                      "📌 Sumber: SolidWorks Drawing / Drafting Tutorial for Beginners - 1 & 2.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                  {
                    id: "exploded_drawing",
                    nama: "Exploded Drawing",
                    materi:
                      "📌 Exploded Drawing\n" +
                      "• Drawing yang nampilin exploded view.\n" +
                      "• Biasanya dipakai buat manual book.\n\n" +
                      "📌 Fitur\n" +
                      "• Bill of Materials (BOM): tabel daftar part.\n" +
                      "• Balloons: nomor part yang nunjuk ke BOM.\n" +
                      "• Auto Balloon: otomatis kasih nomor.\n\n" +
                      "📌 Best Practice\n" +
                      "• Urutin BOM biar rapi.\n" +
                      "• Balloons jangan overlap.\n\n" +
                      "📌 Sumber: SolidWorks Exploded View Drawing Tutorial.",
                    gdriveUrl: "",
                    catatan: "",
                  },
                ],
              ...
              {
                id: "surface_modeling",
                nama: "Surface Modeling",
                materi:
                  "📌 Surface Modeling\n" +
                  "• Fungsi: bikin permukaan (bukan solid) yang bisa digabung jadi solid.\n" +
                  "• Cocok buat bentuk kompleks yang susah dibikin solid.\n\n" +
                  "📌 Tools Dasar\n" +
                  "• Extruded Surface, Revolved Surface, Swept Surface, Lofted Surface.\n" +
                  "• Trim Surface, Extend Surface, Knit Surface.\n" +
                  "• Thicken: ubah surface jadi solid.\n\n" +
                  "📌 Best Practice\n" +
                  "• Surface dipakai buat bentuk organik (mobil, pesawat).\n" +
                  "• Gabungin surface jadi solid di akhir.\n\n" +
                  "📌 Sumber: SolidWorks Surface Modeling Basics Tutorial.",
                gdriveUrl: "",
                catatan: "",
              },
              {
                id: "advanced_modeling",
                nama: "Advanced Modeling",
                materi:
                  "📌 Advanced Modeling\n" +
                  "• Teknik modeling tingkat lanjut.\n" +
                  "• Biasanya gabungan beberapa fitur: loft, boundary, surface.\n\n" +
                  "📌 Topik\n" +
                  "• Multi-body modeling.\n" +
                  "• Combine, Split, Move/Copy Body.\n" +
                  "• Shell: bikin benda berongga.\n" +
                  "• Wrap: tempel gambar/teks ke permukaan.\n" +
                  "• Flex: bikin benda fleksibel.\n\n" +
                  "📌 Best Practice\n" +
                  "• Plan dulu sebelum modeling.\n" +
                  "• Pakai fitur yang paling simpel.\n\n" +
                  "📌 Sumber: SolidWorks Advanced Modeling Tutorial.",
                gdriveUrl: "",
                catatan: "",
              },
              {
