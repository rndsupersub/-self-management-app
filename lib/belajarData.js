...
export const DEFAULT_WARNA_KATEGORI = { design: "purple", bahasa: "blue", agama: "green" };
...
export const DEFAULT_TARGET_HARIAN = { design: { target: 1, satuan: "materi" }, bahasa: { target: 1, satuan: "materi" }, agama: { target: 1, satuan: "bab" } };
